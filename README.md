...
This branch contains sources for the Zybo Z7-10 HDMI Demo.
...
Since the demo uses the USB-UART bridge to configure the HDMI Display, the Zybo Z7-10 must be connected to a computer over MicroUSB, which must be running a serial terminal. For more information on how to set up and use a serial terminal, such as Tera Term or PuTTY, refer to [this tutorial](https://reference.digilentinc.com/learn/programmable-logic/tutorials/tera-term).
...
For more information on the Zybo Z7-10 HDMI Demo, including setup instructions, visit its [Demo Page](https://reference.digilentinc.com/reference/programmable-logic/zybo-z7/demos/hdmi) on the Digilent Wiki.
...
* **Zybo Z7-10**
* **Vivado and Vitis 2023.1 Installations**
